...
namespace API.Controllers
{
    ...
    public class OrdersController : BaseApiController
    {
        ...
        public async Task<ActionResult<IReadOnlyList<OrderToReturnDto>>> GetAllPendingOrders()
        {
        ...
        public async Task<ActionResult<OrderToReturnDto>> AcceptOrder(int id)
        {
            ...
            return Ok(mapper.Map<Order, OrderToReturnDto>(updatedOrder));
        }
        [Authorize(Roles = "Admin")]
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<OrderToReturnDto>> DeleteOrder(int id)
        {
